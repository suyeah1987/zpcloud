...
INSTALL_LIST="biosdevname curl wget htop iotop tcpdump unzip vim-minimal ethtool lsscsi lshw
              lsof nano parted rsync pciutils strace logrotate man man-pages expect"

UNINSTALL_LIST="NetworkManager polkit"
